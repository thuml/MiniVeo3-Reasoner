...
parser.add_argument("--output-dir","-o",type=str,default=default_output_dir,help="Directory to save output files, default='output'")
parser.add_argument("--grid-n","-s",type=int,default=default_maze_size,help="Size of the maze (grid_n by grid_n), default=3")
parser.add_argument("--n-mazes","-n",type=int,default=default_n_mazes,help="Number of mazes to generate, default=10")
parser.add_argument("--min-path-length","-l",type=int,help="(Optional) Minimum path length, default=2")
parser.add_argument("--max-path-length","-r",type=int,help="(Optional) Maximum path length, default=2*grid_n")
parser.add_argument("--create-algo","-c",type=str,default=default_maze_ctor,help="(Optional) Maze generation algorithm, default='gen_kruskal'")
